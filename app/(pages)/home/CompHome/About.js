...
export default function About() {
  return (
    <section className="p-4 text-center d-flex justify-content-center align-items-center" style={{ backgroundImage : 'url(/img/home/net-bg-1.jpg)', minHeight : '70%'}}>
      <div className="container ">
        
        <div className="">
          <h1 className="text-white fw-bolder h1 py-5">Connecting people from +10 years</h1>
