  ...
  return (
    <div className="dropdown dropdown-menu-sm-end dropdown-menu-md-start">
      ...
      <ul className="dropdown-menu p-0">
        <li><Link className="dropdown-item border-bottom text-primary py-2 fw-bold small" href={ `/es/profile/${session?.user.id}`} >Mio Profilo</Link></li>
        <li><Link className="dropdown-item py-2 small" href="/es/profile/newproject">Nuovo Progetto</Link></li>
        <li><Link className="dropdown-item py-2 small" href="/es/auth/reset-password">Reset Password</Link></li>
