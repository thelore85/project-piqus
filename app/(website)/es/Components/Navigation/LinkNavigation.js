      ...
      <ul className="navbar-nav mb-2 me-auto mb-lg-0 small fw-light">
        <li className="nav-item dropdown m-2">
          ...
          <ul className="dropdown-menu small fw-normal text-primary px-4 mt-2 " style={{width:'auto', minWidth:"350px", listStyle:"disc"}}>
            <li className="m-2">
              <Link className="" aria-current="page" href="/es/web-developing">Web Developing</Link>
            </li>
            <li className="m-2">
              <Link className="" aria-current="page" href="/es/marketing-online">Online Marketing</Link>
            </li>
          </ul>
        </li>

        <li className="nav-item m-2 ">
          <Link className="text-light" aria-current="page" href="/es/home/#about">About</Link>
        </li>
        <li className="nav-item m-2 ">
          <Link className="text-light" aria-current="page" href="/es/home/#portfolio">Portfolio</Link>
        </li>
      </ul>
  )
}
