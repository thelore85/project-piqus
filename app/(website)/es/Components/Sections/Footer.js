      ...
      <div className="row">
        ...
        <div className="col-6 col-md-3 mb-4">
            ...
            <ul className="nav flex-column small">
              <li className="nav-item mb-2 fw-lighter p-0 small"><Link href="https://api.whatsapp.com/send/?phone=0034615867600&text&type=phone_number&app_absent=0" target='_blank'>Whatsapp</Link></li>
        ...
        <div className="col-6 col-md-3 mb-4">
            ...
            <ul className="nav flex-column small">
              <li className="nav-item mb-2"><Link href="/es/auth/login" className="fw-lighter p-0 small">Login</Link></li>
              <li className="nav-item mb-2"><Link href="/es/auth//signup" className="fw-lighter p-0">Signup</Link></li>
