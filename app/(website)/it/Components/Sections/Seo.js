      ...
      <div className="container text-dark py-4" style={{ maxWidth: '1000px' }}>
        ...
        <div className="row border-bottom g-4">
          ...
          <div className="col-md-12 mb-3">
            ...
            <h5 className="fw-bold mb-4" style={{ textWrap:"balance"}}>Ottimizzazione per i Motori di Ricerca, Copywriting, Strategie di Contenuto</h5>
            <p>Eleva la tua presenza digitale dalle strategie SEO ai contenuti, fino all&#39;ottimizzazione di Google Business.</p>
            <p className="d-none d-sm-block" style={{ textWrap:"balance"}}>
