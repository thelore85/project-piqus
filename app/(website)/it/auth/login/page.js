  ...
  return (
    <section className="dark-bg w-100 h-100 py-3 d-flex justify-content-center align-items-center" style={{ backgroundImage : 'url(/img/home/net-bg-4.jpg)', backgroundSize : 'cover', backgroundPosition : 'center'}}>
      ...
      <div className="p-3 mt-4 rounded bg-white text-secondary">
        <p className="mb-0 small py-1">Non hai un&apos;account? <Link href="/it/auth/signup" className="text-primary fw-bold">Registrti Qui</Link></p>
        <p className="mb-0 small py-1">Dimenticato la password? <Link href="/it/auth/reset-password" className="text-primary fw-bold">Recupera la password</Link></p>
      </div>
