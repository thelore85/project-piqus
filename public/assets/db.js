...
export const pjt =[
  { 
    ...
    clientDescription: 'Phisioterapy studio in Milan - Italy',
...

  {
    ...
    description: "Go-to-market strategy and execution for the launch of the Generali Trading Platform, a collaboration between Banca Generali and Saxo Bank. The project involved comprehensive brand positioning and online marketing.",
    ...
    tech: ["Online Marketing", "Brand Positioning", "Digital Advertising", "Content Marketing"],
    category: ["marketing"],
    color: [165, 47, 25],
    gitCode: "",
...
},
{
  ...
  clientIndustries: "Events",
  clientLogo: "/img/partners/piqus/piqus.png",
  clientImage: "/img/partners/piqus/wedding_website.png",
  tech: ["Node.js", "React", "Bootstrap", "Nodemailer", "Express.js", "JavaScript/HTML/CSS", "Vercel"],
  category: ["developing"],
  color: [255, 192, 203],
